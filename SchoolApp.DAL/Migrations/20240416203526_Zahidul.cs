...
{
    /// <inheritdoc />
    public partial class Zahidul : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 111, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(6970), null, true, 0 },
                    { 2, 111, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7018), null, true, 0 },
                    { 3, 111, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7027), null, true, 0 },
                    { 4, 111, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7035), null, true, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Improved student performance by 20%", "ABC School", "Teacher", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(9153), "Teaching Mathematics and Physics", null },
                    { 2, "Improved student performance by 20%", "ABC School", "Teacher", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(9177), "Teaching Mathematics and Physics", null },
                    { 3, "Improved student performance by 20%", "ABC School", "Teacher", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(9189), "Teaching Mathematics and Physics", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "30 students", "Class One" },
                    { 2, "35 students", "Class Two" },
                    { 3, "35 students", "Class Three" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7854), 1, 1 },
                    { 2, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7876), 2, 2 },
                    { 3, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7886), 3, 3 },
                    { 4, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7956), 1, 1 },
                    { 5, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7968), 2, 2 },
                    { 6, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(7978), 3, 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Good job!", 1, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(8560), 65, 40, 0, 1, 1, 1, 80 },
                    { 2, "Excellent work!", 0, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(8585), 75, 40, 0, 2, 2, 2, 90 },
                    { 3, "Excellent work!", 0, new DateTime(2024, 4, 17, 2, 35, 8, 56, DateTimeKind.Local).AddTicks(8603), 75, 40, 0, 3, 3, 3, 90 }
                });
