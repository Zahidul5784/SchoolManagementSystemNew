...
namespace SchoolApiService.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteDepartment(int id)
        {
            ...
            // Manually handle related records in the Staff table
            var staffInDepartment = _context.dbsStaff.Where(s => s.DepartmentId == id);
            foreach (var staff in staffInDepartment)
            {
                staff.DepartmentId = null; // Or reassign to a different department
            }
